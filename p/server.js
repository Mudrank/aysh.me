var lol = Math.floor(Math.random() * 7);
var cursor = ["⚡", "✨", "🦄", "🌈", "🍄", "🥐", "🛴"];
var yo = cursor[lol];
console.log(yo);
document.getElementsByTagName(
  "body"
)[0].style.cursor = `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg'  width='50' height='60' viewport='0 0 100 100' style='fill:black;font-size:30px;'><text y='50%'>${yo}</text></svg>") 16 0, default`;
...
function activateCheats() {
  ...
  document.getElementById("me").src =
    "https://cdn.glitch.com/fa8e25d3-1b37-4b2e-81f3-3972f497af8d%2Fme.png?v=1620396075727";
  for (var i = 0; i <= 360; i++) {
